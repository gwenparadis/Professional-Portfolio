    ...
    <div class="bg-dark text-white p-5">
      ...
      <div class="container p-2">
        ...
        <div class="p-2">
          <ul>
            <li>
              Built and deployed 18 individual mini-projects containing HTML,
              CSS, and JavaScript elements
            </li>
            <li>
              Utilized Agile Methodologies to collaborate with classmates to
              create 3 separate projects
            </li>
            <li>
              Maintained a 3.7 GPA or above for the entirety of the 24-week
              bootcamp experience
            </li>
          </ul>
        </div>
      ...
      <div class="container p-2">
        <div class="p-2">
          ...
          <h6>
            Field: Community Building and Management, Sports and Recreation
          </h6>
        </div>
